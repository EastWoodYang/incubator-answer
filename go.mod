...
require (
	...
	github.com/apache/incubator-answer-plugins/cache-redis v1.2.9
	github.com/apache/incubator-answer-plugins/captcha-basic v1.0.4
	github.com/apache/incubator-answer-plugins/cdn-aliyun v1.0.2
	github.com/apache/incubator-answer-plugins/connector-basic v1.2.8
	github.com/apache/incubator-answer-plugins/render-markdown-codehighlight v0.2.2
	github.com/apache/incubator-answer-plugins/search-algolia v1.2.10
	github.com/apache/incubator-answer-plugins/storage-aliyunoss v1.2.9
...
require (
	...
	github.com/algolia/algoliasearch-client-go/v3 v3.29.2 // indirect
